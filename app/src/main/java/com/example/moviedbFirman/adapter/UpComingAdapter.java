package com.example.moviedbFirman.adapter;
...
public class UpComingAdapter extends RecyclerView.Adapter<UpComingAdapter.CardViewViewHolder>
{
    ...
    public class CardViewViewHolder extends RecyclerView.ViewHolder {
        ...
        public CardViewViewHolder(@NonNull View itemView) {
            super(itemView);
            img_poster = itemView.findViewById(R.id.poster_card_upcoming);
            lbl_title = itemView.findViewById(R.id.lbl_title_upcoming);
